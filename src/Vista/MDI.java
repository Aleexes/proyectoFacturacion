...
import static Vista.JIFSistema.controlVentanaSistema;
import static Vista.JIFAgregarAdmin.controlVentanaAgregarAdmin;
import static Vista.JIFNegocio.controlVentanaNegocio;
import static Vista.JIFAdmin.controlVentanaAdmin;
import static Vista.JIFModeloResolucion.controlVentanaModeloResolucion;
import static Vista.JIFClientes.controlVentanaClientes;
import static Vista.JIFFactura.controlVentanaFacturacion;
//FINAL: IMPORTS PARA CONTROL DE VENTANAS
...
public class MDI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jDesktopPane1.setBounds(0, 0, 1500, 680);

        menuLogin.setMnemonic('f');
        menuLogin.setText("File");
    ...
    public static boolean controlVentanaLogin = false;
    ...
    private void MenuLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuLoginActionPerformed
        ...
        if (controlVentanaLogin) { //SI YA HAY UNA VENTANA LOGIN ABIERTA, NO ABRIR OTRA
            return;
        }
        ...
        repaint();
        revalidate();
        dejarDisponibleVentanas();

        JIFLogin vistaL = new JIFLogin();
        UsuarioDAO modeloL = new UsuarioDAO();
        ControladorLogin controladorL = new ControladorLogin(vistaL, modeloL);
        vistaL.setLocation(((jDesktopPane1.getSize()).width - (vistaL.getSize()).width) / 2, ((jDesktopPane1.getSize()).height - (vistaL.getSize()).height) / 2);
        jDesktopPane1.add(vistaL);
